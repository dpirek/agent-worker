...
import { createReadOfficeContextTool } from "./read-office-context.js";
import { createReadFileTool } from "./read-file.js";
import { createRunCommandTool } from "./run-command.js";
import { createSearchFilesTool } from "./search-files.js";
import { createAskTeammateTool, createListTeammatesTool } from "./team-collaboration.js";
...
const builtInToolFactories = Object.freeze([
  ...
  ["read_office_context", createReadOfficeContextTool],
  ["list_teammates", createListTeammatesTool],
  ["ask_teammate", createAskTeammateTool],
...
function createToolRegistry(initialFactories = []) {
  ...
  function createTools({ root, approve = async () => false, env = process.env, fetchImpl = fetch }) {
    const context = { ...createWorkspaceContext({ root, approve }), env, fetchImpl };
