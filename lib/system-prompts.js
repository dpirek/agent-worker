...
Never claim that you lack file or command access without first checking the enabled tools.`,
  response_format: `Return the final response as Markdown. When you create a file, include a clickable
...
const SYSTEM_PROMPT_TITLES = {
  ...
  response_format: "Response format and resource links",
