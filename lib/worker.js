...
function createWorkerServer({
  ...
  function enqueue({ taskId = crypto.randomUUID(), messageId, text, internal = false, resourceBaseUrl, connectionId = null, sendUpdate = null, mcpServers, artifactUpload, projectId = "central-office", officeTaskId = null }) {
