...
function createWorkerServer({
  ...
  function enqueue({ taskId = crypto.randomUUID(), messageId, text, internal = false, resourceBaseUrl, connectionId = null, sendUpdate = null, mcpServers, projectId = "central-office", officeTaskId = null }) {
    ...
    const job = {
      ...
      mcpServers, projectId, officeTaskId,
